...
class RatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post rates_url, params: { rate: { rate_score: @rate.rate_score, restaurant_id: @rate.restaurant_id, user_id: @rate.user_id } }
    end
  ...
  test "should update rate" do
    patch rate_url(@rate), params: { rate: { rate_score: @rate.rate_score, restaurant_id: @rate.restaurant_id, user_id: @rate.user_id } }
