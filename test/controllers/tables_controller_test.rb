...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { customer_capacity: @table.customer_capacity, restaurant_id: @table.restaurant_id, table_number: @table.table_number } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { customer_capacity: @table.customer_capacity, restaurant_id: @table.restaurant_id, table_number: @table.table_number } }
