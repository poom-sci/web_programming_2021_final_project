...
class FavouritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favourite" do
    assert_difference('Favourite.count') do
      post favourites_url, params: { favourite: { restaurant_id: @favourite.restaurant_id, user_id: @favourite.user_id } }
    end
  ...
  test "should update favourite" do
    patch favourite_url(@favourite), params: { favourite: { restaurant_id: @favourite.restaurant_id, user_id: @favourite.user_id } }
